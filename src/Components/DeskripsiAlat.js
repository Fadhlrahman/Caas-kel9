    ...
    return (
        <Container className="text-justify justify-content-center " >
            ...
            <p className="text-black section"> {/* Mengubah warna teks menjadi putih */}
                IoT Smart Door Access dan Automatic Lamp adalah solusi inovatif yang menggabungkan teknologi Internet of Things (IoT) untuk memberikan akses pintu yang aman dan efisien serta mengatur pencahayaan ruangan secara otomatis.
            </p>
